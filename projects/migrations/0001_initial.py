    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visibility', models.CharField(choices=[('university', 'University'), ('cross_university', 'Cross University'), ('public', 'Public')], default='university', help_text='Project visibility level', max_length=20)),
